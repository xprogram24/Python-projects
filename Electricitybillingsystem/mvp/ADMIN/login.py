...
def login():
    ...
    confirmQuery = "SELECT admin_password from myAdmin WHERE Email = %s"
    ...
    if pa:
        ...
        if mypassword is None:
            ...
            query  = "UPDATE myAdmin SET admin_password = %s Where email = %s "
        ...
        print("email not found meet ICT department for further assistance")
